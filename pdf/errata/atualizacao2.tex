...
%Em relação aos tópicos abordados no livro, três elementos sofreram alterações, dois na sintaxe e um no output. O que sofreu alteração no output, não tem problema no uso ao longo dos códigos.
